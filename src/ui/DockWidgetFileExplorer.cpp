...
DockWidgetFileExplorer::DockWidgetFileExplorer(QWidget *parent, QString workingDir) : QDockWidget(parent)
{
    ...
    _dockwidget.lineEditAddressBar->setMinimumHeight(_dockwidget.lineEditFilter->minimumHeight());
    _dockwidget.lineEditAddressBar->setMaximumHeight(_dockwidget.lineEditFilter->maximumHeight());
    _dockwidget.lineEditAddressBar->setFixedHeight(_dockwidget.lineEditFilter->height());
    ...
    _dockwidget.lineEditAddressBar->setText(workingDir);
